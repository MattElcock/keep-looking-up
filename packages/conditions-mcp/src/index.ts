...
import registerToolGetAtmosphericConditions from "./tools/getAtmosphericConditions.js";
...
const createMcpServer = (): McpServer => {
  ...
  registerToolGetAtmosphericConditions(server);
...
app.listen(PORT, () => {
  console.log(`Conditions MCP running on http://localhost:${PORT}`);
